...
export default function ForgotPassword({ navigation }) {
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setStatus({ type: "success", message: "Email envoyé. Vérifie ta boîte de réception." });
      } else {
...
const styles = StyleSheet.create({
  ...
  back: { color: "black", marginBottom: 20 },
  title: {
    fontSize: 22,
    fontWeight: "700",
    textAlign: "center",
  ...
  formBlock: { alignItems: "center", marginTop: 28, gap: 18 },
